...
public class MyIntegralAdapter extends BaseAdapter {
    private List<MyIntegralBeans.DataBean> mList;
    private Context mContext;
    private LayoutInflater mInflater;
    private InterfaceMyIntegral mInterfaceMyIntegral;

    public MyIntegralAdapter(Context mContext, List<MyIntegralBeans.DataBean> mList) {
        this.mList = mList;
                        ...
                        .execute(new CustomCallBackNoLoading<SignInDuiHuanBeans>(mContext) {
                            ...
                            public void onSuccess(SignInDuiHuanBeans mSignInDuiHuanBeans, Call call, Response response) {
                                if (mSignInDuiHuanBeans.getResultCode() == 1) {
                                    mInterfaceMyIntegral.initFinish();
