...
public class ReceiverMainActivity extends InstrumentedActivity implements OnClickListener{
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.recevier_main);
		initView();   
	...
	public void onClick(View v) {
		...
		case R.id.init:
			...
			break;
		case R.id.setting:
			Intent intent = new Intent(ReceiverMainActivity.this, PushSetActivity.class);
