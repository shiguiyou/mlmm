...
/**
 * Created by XCF on 2018/8/28.
 */

public class PostPersonageCenterIsFollowBeans implements Serializable {
    /**
     * data : {"callBackResult":true,"msg":"您已取消关注该用户","object":null,"result":1,"validateResult":1}
     * dynamicKey :
     * msg : 您已取消关注该用户
     * result : true
     * resultCode : 1
