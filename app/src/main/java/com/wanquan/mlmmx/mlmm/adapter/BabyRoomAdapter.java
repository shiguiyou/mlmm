...
public class BabyRoomAdapter extends BaseAdapter {
    List<BabyRoomGridViewBeans.DataBean> mList;
    Context mContext;
    LayoutInflater mInflater;

    public BabyRoomAdapter(Context mContext, List<BabyRoomGridViewBeans.DataBean> mList) {
        this.mList = mList;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            viewHolder.mItemBabyLL = (LinearLayout) convertView.findViewById(R.id.item_Baby_ll);
            //把当前的控件缓存到布局视图中
        ...
        //显示内容
        final BabyRoomGridViewBeans.DataBean mBabyRoomGridViewBeans = mList.get(position);
