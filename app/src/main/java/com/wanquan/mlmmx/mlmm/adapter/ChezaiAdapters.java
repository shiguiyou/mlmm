...
public class ChezaiAdapters extends BaseAdapter {
    List<BabyRoomDialogGridViewBeans.DataBean.CfsBean> mList2;
    Context mContext;
    LayoutInflater mInflater;

    public ChezaiAdapters(Context mContext, List<BabyRoomDialogGridViewBeans.DataBean.CfsBean> mList2) {
        this.mList2 = mList2;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        Glide.with(mContext).load(mList2.get(position + 1).getIco()).into(viewHolder.mItemBabyImg);
        viewHolder.mItemBabyTv.setText(mList2.get(position + 1).getName());
        return convertView;
    }
}
