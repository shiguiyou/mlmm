 ...
 * 时间：2016.10.10
 */
public class MyPicpupWindows extends PopupWindow {
    ...
    public MyPicpupWindows(Activity context, final View.OnClickListener itemsOnClick, String top) {
        super(context);
        mContext=context;
        LayoutInflater inflater = (LayoutInflater) context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        mMenuView = inflater.inflate(R.layout.photo_chioce_dialogs, null);
