 ...
 * 录制语音feed页面
 */
public class AudioRecordActivity extends FragmentActivity implements RecordAudioView.IRecordAudioListener, View.OnClickListener {
    ...
    public static final long DEFAULT_MAX_RECORD_TIME = 300000;//设置最大录制时长
    public static final long DEFAULT_MIN_RECORD_TIME = 1000;//设置最短录制时长
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recordStatusDescription = new String[]{getString(R.string.ar_feed_sound_press_record), getString(R.string.ar_feed_sound_slide_cancel)};
    ...
    public String onRecordStart() {
        ...
        audioFileName = App.getContext().getExternalCacheDir() + File.separator + createAudioName();
