...
public class MoreServiceGridViewAdapter2 extends BaseAdapter {
    private List<MoreServiceBeans.DataBean.ToolbarList2Bean> mList;
    private Context mContext;
    private LayoutInflater mLayoutInflater;
    private String str;
    private MoreServiceBeans.DataBean.ToolbarList2Bean toolbarList2Bean;
    private ViewHolder viewHolder;

    public MoreServiceGridViewAdapter2(List<MoreServiceBeans.DataBean.ToolbarList2Bean> list, Context context, String str) {
        this.mList = list;
    ...
    public View getView(final int position, View convertView, ViewGroup viewGroup) {
        ...
        toolbarList2Bean = mList.get(position);

        viewHolder.mItemMoreServiceTextView.setText(toolbarList2Bean.getName());


        if ("1".equals(toolbarList2Bean.getOrder())) {//宝宝相册
            viewHolder.mItemMoreServiceImageView.setImageDrawable(mContext.getResources().getDrawable(R.mipmap.babyalbum));
            initShow();
            //为加减图标赋值，让其可以进行点击判断
            if (toolbarList2Bean.getUserId() == null) {
                mList.get(position).setFlag(false);
            } else if (toolbarList2Bean.getUserId() != null) {
                mList.get(position).setFlag(true);
            }

        } else if ("2".equals(toolbarList2Bean.getOrder())) {//情感日志
        ...
        } else if ("3".equals(toolbarList2Bean.getOrder())) {//发育变化
        ...
        } else if ("4".equals(toolbarList2Bean.getOrder())) {//宝宝听听
        ...
        } else if ("5".equals(toolbarList2Bean.getOrder())) {//亲子游戏
        ...
        } else if ("7".equals(toolbarList2Bean.getOrder())) {//数胎动
        ...
        } else if ("8".equals(toolbarList2Bean.getOrder())) {//产检提醒
        ...
        } else if ("10".equals(toolbarList2Bean.getOrder())) {//孕期食谱
        ...
        } else if ("11".equals(toolbarList2Bean.getOrder())) {//看懂B超单
        ...
        } else if ("12".equals(toolbarList2Bean.getOrder())) {//亲子任务
        ...
        } else if ("13".equals(toolbarList2Bean.getOrder())) {//成长曲线
        ...
        } else if ("14".equals(toolbarList2Bean.getOrder())) {//疫苗提醒
        ...
        } else if ("15".equals(toolbarList2Bean.getOrder())) {//月子餐
        ...
        } else if ("16".equals(toolbarList2Bean.getOrder())) {//能不能吃
        ...
        } else if ("6".equals(toolbarList2Bean.getOrder())) {//成长评测
        ...
        } else if ("9".equals(toolbarList2Bean.getOrder())) {//知识百科
    ...
    private void initShow() {
        if ("2".equals(str)) {//完成显示
            ...
            if ("0".equals(toolbarList2Bean.getOptional())) {
                viewHolder.mItemMoreServiceAd.setVisibility(View.GONE);

            } else if ("1".equals(toolbarList2Bean.getOptional())) {
